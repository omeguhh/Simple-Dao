...
import "./pages.css";
import { TabList, Tab, Widget, Tag, Table, Form, Tooltip, Blockie, Icon} from "web3uikit"
...
const Proposal = () => {
  ...
  async function castVote(upDown) {
    ...
    let options = {
      contractAddress: "0xF838FCDbB9895c1B2b83Eee16BBE399300fc89E5",
        ...
        <div className="proposal">
          <Link to="/">
            <div className="backHome">
              {/* <Icon fill="#ffffff" size={20} svg="cheveronLeft" /> */}
              Overview
            </div>
          </Link>
